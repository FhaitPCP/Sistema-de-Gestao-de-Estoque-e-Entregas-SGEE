...
* Clone o repositório:
git clone [https://github.com/seu-usuario/Sistema-de-Gestao-de-Estoque-e-Entregas-SGEE.git](https://github.com/FhaitPCP/Sistema-de-Gestao-de-Estoque-e-Entregas-SGEE.git)
cd sgee
